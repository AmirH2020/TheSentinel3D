...
namespace TheSentinel.Cores
{
    public class UpgradePopulator
    {
        ...
        {
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("+0.05s Main Gun Fire Rate", () => { GunController.Instance.ModifyFireRate(0.05f, 0); }, UpgradeColor.Red, true, level: 1, index: 1,UpgradePath.Both));
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("+0.1s Main Gun Fire Rate", () => { GunController.Instance.ModifyFireRate(0.1f, 0); }, UpgradeColor.Red, false, level: 2, index: 1, UpgradePath.Both));
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("+150 Ammo", () => { GunController.Instance.AddAmmo(150); }, UpgradeColor.Red, PathChoice.InfinitePlayerHp, level: 1, index: 3,UpgradePath.Hp));
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("+10 Main Gun Capacity", () => { GunController.Instance.ModifyMaxChamber(10, 0); }, UpgradeColor.Red, PathChoice.InfinitePlayerHp, level: 1, index: 1, UpgradePath.Hp));
            ...
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("Decrease Overheating Rate", () => { GunController.Instance.ModifyOverheatingRate(0.3f); }, UpgradeColor.Red, PathChoice.InfiniteAmmo, level: 1, index: 4, UpgradePath.Ammo));
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("Decrease Overheating Rate", () => { GunController.Instance.ModifyOverheatingRate(0.2f); }, UpgradeColor.Red, false, level: 2, index: 4, UpgradePath.Ammo));
            ...
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("- 0.1f Shotgun Fire Rate", () => { GunController.Instance.ModifyFireRate(0.1f, 1); },
                UpgradeColor.Purple, SkillManager.GetSkill<Shotgun>()?.HaveSkill ?? false, level: 1, index: 9, UpgradePath.Both));
            UpgradeScript.Instance.AllUpgrades.AddT(new Upgrade("+ 2 Shotgun Damage", () => { GunController.Instance.ModifyDamage(2, 1); },
