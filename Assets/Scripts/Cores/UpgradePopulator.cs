...
namespace TheSentinel.Cores
{
    public class UpgradePopulator
    {
        public static void AddUpgrades()
        {
            ...
            UpgradeScript.Instance.AllUpgrades.Add(new Upgrade("+150 Ammo", () => { GunScript.Instance.AddAmmo(150); }, UpgradeColor.Red, PathChoice.InfinitePlayerHp, level: 1, index: 3));
            UpgradeScript.Instance.AllUpgrades.Add(new Upgrade("+10 Main Gun Capacity", () => { GunScript.Instance.ModifyMaxChamber(10, 0); }, UpgradeColor.Red, PathChoice.InfinitePlayerHp, level: 1, index: 1));
            ...
            UpgradeScript.Instance.AllUpgrades.Add(new Upgrade("+25% Move Speed", () => { UpgradeMethodes.GetMoveSpeed(25); }, UpgradeColor.Red, false, level: 2, index: 2));
            UpgradeScript.Instance.AllUpgrades.Add(new Upgrade("Decrease Overheating Rate", () => { GunScript.Instance.ModifyOverheatingRate(0.3f); }, UpgradeColor.Red, PathChoice.InfiniteAmmo, level: 1, index: 4));
